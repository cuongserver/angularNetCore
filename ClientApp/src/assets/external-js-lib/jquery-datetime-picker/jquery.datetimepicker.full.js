...
!function(){
  ...
  DateFormatter.prototype = {
    ...
    parseDate: function (e, r) {
      ...
      var g = !1;
      var m = !1;
      var p = d.dateSettings;
      var y = { date: null, year: null, month: null, day: null, hour: 0, min: 0, sec: 0 };
      if (!e) return null;
      ...
      for (a = e.replace(d.separators, "\x00").split("\x00"), u = 0; u < a.length; u++) {
        switch (i = a[u], s = parseInt(i), n[u]) {
          ...
          case "Y":
            if (!s) return null;
            l = i.length;
            y.year = 2 === l ? parseInt((70 > s ? "20" : "19") + i) : s, g = !0;
            break;
          case "m":
          case "n":
          case "M":
    ...
    guessDate: function (t, e) {
      ...
      var c = t.replace(o.separators, "\x00").split("\x00");
      var f = /^[djmn]/g;
      var l = e.match(o.validParts);
      var h = new Date;
      var d = 0;
      ...
      for (a = 0; a < c.length; a++){
        ...
        switch (a) {
          case 0: "m" === l[0] || "n" === l[0] ? h.setMonth(s - 1) : h.setDate(s);
            break;
          case 1: "m" === l[0] || "n" === l[0] ? h.setDate(s) : h.setMonth(s - 1);
            break;
          case 2:
    ...
    parseFormat: function (t, r) {
      ...
      return n = {
        ...
        B: function () {
          var t = r.getUTCHours() * i, n = 60 * r.getUTCMinutes();
        ...
        I: function () {
          var t = new Date(n.Y(), 0), e = Date.UTC(n.Y(), 0), r = new Date(n.Y(), 6), a = Date.UTC(n.Y(), 6); return t - e !== r - a ? 1 : 0
        },
        O: function () {
    ...
    formatDate: function (t, e) {
      ...
      if (t instanceof Date) {
        ...
        "S" !== i && i !== c && (r > 0 && e.charAt(r - 1) === c ? o += i : (u = s.parseFormat(i, t), r !== a - 1 && s.intParts.test(i) && "S" === e.charAt(r + 1) && (n = parseInt(u) || 0, u += s.dateSettings.ordinal(n)), o += u));
        return o
      }
      return ""
    }
